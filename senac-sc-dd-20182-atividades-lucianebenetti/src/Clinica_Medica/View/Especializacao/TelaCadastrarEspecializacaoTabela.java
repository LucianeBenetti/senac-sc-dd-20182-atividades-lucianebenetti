...
public class TelaCadastrarEspecializacaoTabela extends JPanel {
	...
	public TelaCadastrarEspecializacaoTabela() {
		...
		btnSair.setBounds(911, 584, 107, 31);
		add(btnSair);
		...
		btnCadastrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (controlador.existeEspecializacao(especializacao)) {
		...
		btnCadastrar.setBounds(734, 584, 114, 31);
		add(btnCadastrar);
		...
		btnBuscar.setBounds(927, 19, 91, 31);
		add(btnBuscar);

		JSeparator separator = new JSeparator();
		separator.setBounds(304, 124, 717, 14);
		add(separator);
		...
		btnAlterar.setBounds(537, 584, 133, 30);
		add(btnAlterar);
		...
		separator_1.setBounds(307, 350, 711, 16);
		add(separator_1);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(299, 149, 717, 172);
		add(scrollPane);
